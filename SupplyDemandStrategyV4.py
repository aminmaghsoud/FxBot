...
#Buy            
                ...
                TP1 =  PublicVarible.BaseroofN + (abs(PublicVarible.BaseroofN - PublicVarible.BasefloorN) *   1) 
...
#Sell
                ...
                SL = PublicVarible.BaseroofN + ( SymbolInfo.point * 100)  #((PublicVarible.BaseroofN - PublicVarible.BasefloorN)/2)                     #########  تعیین حدضرر معامله #########
                   #TP1 = EntryPrice + ((EntryPrice - SL) * 1  )
                TP1 = PublicVarible.BasefloorN- (abs(PublicVarible.BaseroofN - PublicVarible.BasefloorN) * 1) 
